...
export type CoachAssignment = {
  ...
  id?: Maybe<Scalars["ID"]["output"]>
  itemCompletionStatesForAllStudents?: Maybe<
    Array<Maybe<CoachAssignmentItemCompletionStates>>
  >
}
...
export type LoginWithPasswordMutationMutation = {
  __typename?: "Mutation"
  loginWithPassword: {
    __typename: "LoginWithPasswordMutation"
    ...
    user?: {
      ...
      id: string
      kaid?: string | null
      canAccessDistrictsHomepage?: boolean | null
      isTeacher?: boolean | null
      hasUnresolvedInvitations?: boolean | null
      transferAuthToken?: string | null
      preferredKaLocale?: {
        __typename: "Locale"
        id: string
        kaLocale?: string | null
        status?: string | null
      } | null
    } | null
    error?: {
...
export type RequestAdminReportCsvMutationVariables = Exact<{
  ...
  >
  teacherKaids?: InputMaybe<
    Array<Scalars["String"]["input"]> | Scalars["String"]["input"]
  >
  courseSISValues?: InputMaybe<
    Array<Scalars["String"]["input"]> | Scalars["String"]["input"]
  >
  courseID?: InputMaybe<Scalars["String"]["input"]>
  strandKey?: InputMaybe<Scalars["String"]["input"]>
...
export type RequestAdminReportCsvMutation = {
  __typename?: "Mutation"
...
export type SignUrlForReportMutation = {
  __typename?: "Mutation"
  signURLForReport: {
    __typename: "SignURLForReportResult"
    url?: string | null
...
export type KhanCoursesQueryQuery = {
  __typename?: "Query"
  districtById?: {
    __typename: "District"
    id: string
...
export type ProgressByStudentQuery = {
  __typename?: "Query"
  coach: {
    __typename: "Coach"
    id?: string | null
    studentList?: Array<{
      ...
      id?: string | null
      cacheId?: string | null
      studentKaidsAndNicknames?: Array<{
        __typename: "CoachStudentKaidsAndNicknames"
        id?: string | null
      ...
      assignmentsPage?: {
        ...
        assignments?: Array<{
          ...
          itemCompletionStates?: Array<{
            __typename: "CoachAssignmentItemCompletionStates"
            completedOn?: string | null
            studentKaid?: string | null
            bestScore?: {
              __typename: "CoachAssignmentItemCompletionStatesBestScore"
...
export type CsvReportStatusQuery = {
  __typename?: "Query"
  getLastNAdminReportsForUser?: {
    ...
    adminReports?: Array<{
      ...
      endDate?: string | null
      schools?: Array<string | null> | null
      createdAt?: string | null
      fileName?: string | null
      fileSize?: string | null
      bands?: Array<string | null> | null
      courseSISValues?: Array<string | null> | null
      teacherKaids?: Array<string | null> | null
...
export type GetLearnMenuProgressQuery = {
  __typename?: "Query"
  user?: {
    __typename: "User"
    id: string
    subjectProgressesBySlug?: Array<{
      __typename: "SubjectProgress"
      topic?: { __typename: "Topic"; id: string; slug?: string | null } | null
      currentMastery?: {
        __typename: "CurationItemMastery"
...
export function getSdk(
  ...
  return {
    loginWithPasswordMutation(
      variables: LoginWithPasswordMutationMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<LoginWithPasswordMutationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<LoginWithPasswordMutationMutation>(
            LoginWithPasswordMutationDocument,
            variables,
    ...
    requestAdminReportCSV(
      variables: RequestAdminReportCsvMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<RequestAdminReportCsvMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RequestAdminReportCsvMutation>(
            RequestAdminReportCsvDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "requestAdminReportCSV",
    ...
    signURLForReport(
      variables: SignUrlForReportMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<SignUrlForReportMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SignUrlForReportMutation>(
            SignUrlForReportDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "signURLForReport",
    ...
    KhanCoursesQuery(
      variables: KhanCoursesQueryQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<KhanCoursesQueryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<KhanCoursesQueryQuery>(
            KhanCoursesQueryDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "KhanCoursesQuery",
    ...
    ProgressByStudent(
      variables: ProgressByStudentQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<ProgressByStudentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ProgressByStudentQuery>(
            ProgressByStudentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "ProgressByStudent",
    ...
    csvReportStatus(
      variables: CsvReportStatusQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<CsvReportStatusQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CsvReportStatusQuery>(
            CsvReportStatusDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "csvReportStatus",
    ...
    getLearnMenuProgress(
      variables?: GetLearnMenuProgressQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetLearnMenuProgressQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetLearnMenuProgressQuery>(
            GetLearnMenuProgressDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "getLearnMenuProgress",
